...
public class SavedNewsAdapter extends RecyclerView.Adapter<SavedNewsAdapter.SavedNewsViewHolder> {
    ...
    // define interface in the adapter
    ...
    // call back function usage in java.
    private ItemCallback itemCallback;

    // pass implementation into the adapter from the outside.
    ...
    public void onBindViewHolder(@NonNull SavedNewsViewHolder holder, int position) {
        ...
        // only fragment can operate view model, if we import viewModel as attr in adapter, then this adapter cannot be used in other place.
